...
class Processor(torch.nn.Module):
    def __init__(
        ...
        # Create graph processor with specified parameters
    ...
    def forward(self, x: torch.Tensor, edge_index, edge_attr) -> torch.Tensor:
        """
        Forward pass for latent graph processing
        ...
        Returns:
            torch Tensor containing the values of the nodes of the graph after processing
        """
